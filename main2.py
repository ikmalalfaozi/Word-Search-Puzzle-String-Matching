    ...
    for word in words:
        ...
        for i in range(m):
            ...
            if (idx != -1):
                ...
                break
            # arah kiri
            idx = BM.bmMatch(reverse(matrix[i]), word)
            if (idx != -1):
                arrayOfIdxWord = []
        ...
        for j in range(n):
            ...
            # atas
            idx = BM.bmMatch(reverse(matrix[:, j]), word)
            if (idx != -1):
                arrayOfIdxWord = []
        ...
        for i, text in enumerate(digRowP):
            ...
            idx = BM.bmMatch(reverse(text), word)
            if (idx != -1):
                arrayOfIdxWord = []
                for k in range(l):
